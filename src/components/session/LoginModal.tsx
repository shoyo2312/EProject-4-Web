    ...
    <div className="fixed inset-0 z-[3001] flex items-center justify-center">
      ...
      >
        ...
        <h2
          ...
          className="mx-auto mt-14 mb-4 w-[380px] max-w-full text-center text-[33px] leading-[49.5px] font-bold text-[var(--tt-text)]"
        >
          Log in to TikTok
        </h2>

        {/* The list scrolls inside the card — the live modal shows five of the
            seven options and clips the sixth, which is how the scroll is
            signalled. */}
